					...
					<div className='order-last content-section lg:order-last w-full'>
						<div className="w-full">
							...
							<p className="text-lg text-gray-600 md:text-xl">
								Managing human resources effectively is a key challenge for businesses of all sizes. At 3Consulting Ltd., our HRIS Servicesprovide comprehensive solutions for managing recruitment, performance, learning, and development, helping your HR team operate more efficiently and your business grow
							</p>
						</div>
					</div>
				</div>
