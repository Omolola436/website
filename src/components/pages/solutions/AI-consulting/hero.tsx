...
import heroImage from "@assets/AI_frame.png";
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 gap-8 z-20  justify-between items-center pt-24 w-full px-4 py-12 md:px-8 md:grid md:grid-cols-2 md:pt-16">
        <div className="mb-6 lg:mb-0">
          ...
          <p className="mb-12 text-2xl font-semibold text-orange-200 md:text-2xl">
            We support organizations in building trustworthy AI systems through AI audits and governance framework development. Our approach ensures responsible AI use, regulatory compliance, and alignment with ethical standards.
          </p>
          <Button
            as="link"
            to="/contact"
