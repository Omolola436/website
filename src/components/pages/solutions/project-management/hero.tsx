...
import heroImage from '@assets/Time management-pana 1.png'
...
const Hero: React.FC = () => {
	return (<section
		...
		className="bg-gradient-to-b from-orange-300 to-white"
	>
		<div
		...
		>
			<div className='grid grid-cols-1 gap-8 justify-between items-center pt-10 w-full md:grid md:grid-cols-2 md:pt-16'>
				<div className='mb-6 lg:mb-0'>
					<div
						id='badge'
						className='inline-flex items-center px-2 py-1 mb-4 max-w-full text-gray-900 bg-white rounded-lg shadow-md md:w-fit'
					>
					...
					<h1 className='py-2 mb-6 text-4xl font-bold leading-tight text-transparent bg-clip-text bg-gradient-to-b from-gray-900 to-gray-700 md:text-3xl lg:text-5xl'>
